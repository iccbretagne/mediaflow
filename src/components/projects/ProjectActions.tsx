  ...
  return (
    <>
            ...
            <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-lg border border-gray-200 py-1 z-20">
              ...
              >
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  Remettre tous les médias en attente
                </p>
              </button>
              {hasPrevalidation && (
                <button
                ...
                >
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">
                    Remettre les médias prévalidés/écartés en attente
                  </p>
                </button>
              )}
            </div>
      ...
      <ConfirmModal
        ...
        message="Tous les médias seront remis en attente."
      ...
      <ConfirmModal
        ...
        message="Les médias prévalidés et écartés seront remis en attente."
        confirmText="Réinitialiser"
        variant="warning"
        loading={resetting}
      />
